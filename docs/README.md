# nsF5 Steganography — 学习手册

项目提供中英文双语学习手册，涵盖从零基础到掌握 LGB 分类器超参调优的完整学习路径。

## 中文版

[📄 学习手册-从零读懂nsF5隐写项目.pdf](学习手册-从零读懂nsF5隐写项目.pdf)

- 67 页，12 周学习路线（每周 6–8 小时）
- 内容：数字图像 → Python 入门 → LSB 隐写 → 卡方/RS 分析 → 汉明矩阵编码 → F5/nsF5 → 湿纸编码 → 哈希键控 → 机器学习基础 → v1/v2 特征工程 → SRM 高通滤波 → 143d/53d 双版本 ML 模型 → C++/GPU 加速 → 综合实验
- 每章配有"动手做"实验与"想一想"思考题

## English Version

[📄 Learning-Handbook-From-Zero-to-nsF5-Steganography.pdf](Learning-Handbook-From-Zero-to-nsF5-Steganography.pdf)

- 76 pages, 12-week roadmap (6–8 hours/week)
...
Companion code: [nsf5-steganography](https://github.com/Yukinoshita-lin/nsf5-steganography)
